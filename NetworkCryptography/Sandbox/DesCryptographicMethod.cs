...
namespace Sandbox
{
    public class DesCryptographicMethod : FiestelCryptographicMethod
    {
        ...
        /// </summary>
        private static int[] InitialPermuation =
        {
        ...
        /// </summary>
        private static int[] FinalPermuation =
        {
        ...
        /// </summary>
        private static int[] ExpansionFunction =
        {
            32, 1, 2, 3, 4, 5,
            4, 5, 6, 7, 8, 9,
            8, 9, 10, 11, 12, 13,
        ...
        /// </summary>
        private static int[] PermuationChoice1 =
        {
            57, 49, 41, 33, 25, 17, 9,
            1, 58, 50, 42, 34, 26, 18,
            10, 2, 59, 51, 43, 35, 27,
        ...
        /// </summary>
        private static int[] PermutedChoice2 =
        {
            14, 17, 11, 24, 1, 5,
            3, 28, 15, 6, 21, 10,
            23, 19, 12, 4, 26, 8,
